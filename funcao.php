...
function horasDisponivel($hora = null) {
    $disponivel = [
        1 => "15:00 horas",
        2 => "20:00 horas"
    ];

    return $hora ? ($disponivel[$hora] ?? "Horário indisponível") : $disponivel;
}
...
echo "Preço com desconto: " .
     formatarPreco(calcularDesconto(75.00, 15)) . "<br>";

echo date('d/m/Y') . "<br>";

echo "Hoje é " . diasDaSemana((int)date('N')) . "<br>";

echo "Horário disponível: " . horasDisponivel(1) . "<br>";
